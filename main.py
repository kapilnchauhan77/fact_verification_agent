...
async def main():
    ...
    parser.add_argument(
        "--mode",
        choices=["document", "text", "interactive"],
        default="interactive",
        help="Operation mode",
    )
        ...
        try:
            ...
            if command.lower() in ["quit", "exit", "q"]:
                ...
                if result["success"]:
                    ...
                    print(
                        f"Overall Score: {result['summary']['overall_authenticity_score']:.2f}"
                    )
                    ...
                    if result["claims"]:
                        ...
                        for i, claim in enumerate(result["claims"][:3], 1):
                            ...
                            print(
                                f"   Score: {claim['verification']['authenticity_score']:.2f}"
                            )
                            print(
                                f"   Level: {claim['verification']['authenticity_level']}"
                            )
